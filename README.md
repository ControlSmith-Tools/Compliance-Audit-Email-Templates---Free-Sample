...
Open the `.md` for copy-paste use or the `.docx` in Word / Google Docs.
Replace the `[BRACKETED]` placeholders and send.
...
Reference material only. Review and adapt all templates before use. Not legal
